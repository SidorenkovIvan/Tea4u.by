...
public class SplashActivity extends AppCompatActivity {
    ...
    private String getRemoteHash() {
        String remoteHash = "";
        try {
            URL url = new URL("https://api.morph.io/SidorenkovIvan/node-scrap/data.json?key=A%2B7AGnCkh%2BGo%2B9arqTu7&query=select%20hash%20from%20%22hash_table%22");
    ...
    private void saveDatabase() {
        try {
            String dbPath = getApplicationInfo().dataDir + "/" + DBname;
            URL url = new URL("https://morph.io/SidorenkovIvan/node-scrap/data.sqlite?key=A%2B7AGnCkh%2BGo%2B9arqTu7");
