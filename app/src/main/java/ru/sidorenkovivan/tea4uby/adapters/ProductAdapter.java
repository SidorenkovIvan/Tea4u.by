...
public class ProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private RecyclerView.ViewHolder getViewHolder(final ViewGroup pParent, final LayoutInflater pInflater) {
        ...
        final View view = pInflater.inflate(R.layout.item_product, pParent, false);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder pHolder, final int pPosition) {
        ...
        if (getItemViewType(pPosition) == mConstants.ITEM) {
            ...
            final Bitmap image = product.getImage();
            final String title = product.getTitle();
            productViewHolder.mImageButton.setImageBitmap(image);
            productViewHolder.mTextView.setText(title);
            productViewHolder.mImageButton.setOnClickListener(view -> {
